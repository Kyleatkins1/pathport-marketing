...
export const TermsOfService: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <main id="main-content" tabIndex={-1} className="py-16 md:py-24 focus:outline-none">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="border-b border-slate-200 dark:border-slate-800 pb-8 space-y-3">
            ...
            <h1 className="text-4xl font-display font-extrabold text-slate-900 dark:text-white">Terms of Service</h1>
            <p className="text-slate-500 dark:text-slate-400 text-xs font-medium">Last Updated: August 14, 2026</p>
          </div>

          <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-xs space-y-6 text-slate-600 dark:text-slate-300 text-xs sm:text-sm leading-relaxed transition-colors">
            <section className="space-y-2.5">
              <h2 className="text-base sm:text-lg font-display font-bold text-slate-900 dark:text-white">1. Acceptance of Terms</h2>
              <p>
            ...
            <section className="space-y-2.5">
              <h2 className="text-base sm:text-lg font-display font-bold text-slate-900 dark:text-white">2. Description of Service</h2>
              <p>
            ...
            <section className="space-y-2.5">
              <h2 className="text-base sm:text-lg font-display font-bold text-slate-900 dark:text-white">3. User Representation & Authenticity</h2>
              <p>
            ...
            <section className="space-y-2.5">
              <h2 className="text-base sm:text-lg font-display font-bold text-slate-900 dark:text-white">4. Beta Program Terms</h2>
              <p>
