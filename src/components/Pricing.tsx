...
export const Pricing: React.FC = () => {
  ...
  return (
    <section id="pricing" className="py-20 md:py-28 bg-slate-50 relative scroll-mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          ...
          <div className="bg-white rounded-3xl p-7 border-2 border-teal-800 shadow-md flex flex-col justify-between space-y-6 relative">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between h-6">
                ...
                <span className="px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-800 text-[10px] font-bold border border-emerald-200 uppercase">
                  Beta Access
                </span>
              </div>
              ...
              <div className="min-h-[64px] flex flex-col justify-center">
                <div className="text-3xl font-display font-black text-slate-900 leading-none">Free</div>
                <div className="text-xs text-emerald-800 font-semibold mt-1.5">Free for lifetime of Beta Cohort</div>
              </div>
              ...
              {/* Feature Checklist */}
              <ul className="space-y-2.5 text-xs text-slate-700 pt-2 border-t border-slate-100 min-h-[160px]">
                <li className="flex items-start gap-2">
                  <Check className="w-3.5 h-3.5 text-teal-800 shrink-0 mt-0.5" />
          ...
          <div className="bg-white rounded-3xl p-7 border border-slate-200/90 shadow-xs flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              {/* Price & Subtitle Row (Fixed Height for Alignment) */}
              <div className="min-h-[64px] flex flex-col justify-center">
                <div className="text-3xl font-display font-black text-slate-900 leading-none">Coming Soon</div>
                <div className="text-xs text-slate-500 mt-1.5">Launch details forthcoming</div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-7 border border-slate-200/90 shadow-xs flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between h-6">
                ...
                <span className="px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-800 text-[10px] font-bold border border-indigo-200 uppercase">
                  Workforce
                </span>
              </div>
              ...
              {/* Price & Subtitle Row (Fixed Height for Alignment) */}
              <div className="min-h-[64px] flex flex-col justify-center">
                <div className="text-3xl font-display font-black text-slate-900 leading-none">Design Partner</div>
                <div className="text-xs text-slate-500 mt-1.5">Employer Workforce Compliance</div>
              </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-900 font-semibold text-xs border border-indigo-200 transition-colors cursor-pointer"
            >
          ...
          <div className="bg-white rounded-3xl p-7 border border-slate-200/90 shadow-xs flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between h-6">
                ...
                <span className="px-2 py-0.5 rounded-full bg-teal-50 text-teal-800 text-[10px] font-bold border border-teal-200 uppercase">
                  Issuers
                </span>
              </div>
              ...
              <div className="min-h-[64px] flex flex-col justify-center">
                <div className="text-3xl font-display font-black text-slate-900 leading-none">Design Partner</div>
                <div className="text-xs text-slate-500 mt-1.5">Issuing Authorities & Programs</div>
              </div>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-teal-50 hover:bg-teal-100 text-teal-900 font-semibold text-xs border border-teal-200 transition-colors cursor-pointer"
            >
              Talk With Our Team
            </button>
          </div>
